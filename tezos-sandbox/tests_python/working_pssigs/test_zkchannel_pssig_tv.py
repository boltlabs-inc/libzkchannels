...
def scenario_cust_close():
    ...
    with Sandbox(paths.TEZOS_HOME, constants.IDENTITIES) as sandbox:
        ...
        # to test pssig in isolation
        # chan_id = "0x67a6833570f081f32b47b8f56e95f5b627f7ea78d08d49f5a1e1c16e6eadcd37"
        # #rev_lock = "0xc498a81ec499243e5cee4befdcbc26d44a2295f27580cbff5df093853d210e29"
        # rev_lock_b = "0xc498a81ec499243e5cee4befdcbc26d44a2295f27580cbff5df093853d210e29"
        ...
        # stack_args = "(Pair (Pair (Pair {chan_id} (Pair 1000000 {cust_bal_b})) \
        #                        (Pair (Pair {g2} 29000000) (Pair {merch_bal_b} {merch_pk0}))) \
        #                  (Pair (Pair (Pair {merch_pk1} {merch_pk2}) (Pair {merch_pk3} {merch_pk4})) \
        #                        (Pair (Pair {rev_lock} \
        #                                    {rev_lock_b}) \
        #                              (Pair {s1} {s2}))))".format(s1=s1, s2=s2, g2=g2, merch_pk0=merchPk0, chan_id=chan_id,
        #                              merch_pk1=merchPk1, merch_pk2=merchPk2, merch_pk3=merchPk3, merch_pk4=merchPk4, 
        #                              rev_lock=rev_lock_b, rev_lock_b=rev_lock_b, cust_bal_b=cust_bal_b, merch_bal_b=merch_bal_b)
        ...
        contract = "zkchannel_mock_main.tz"
