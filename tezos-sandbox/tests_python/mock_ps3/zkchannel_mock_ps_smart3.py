...
class ZkChannel(sp.Contract):
    ...
    def custClose(self, params):
        ...
        params = sp.record(
            ...
            custBalB = params.newCustBalB,
            merchBalB = params.newMerchBalB,
            revLock = params.revLock,
            revLockB = params.revLock,
            s1 = params.s1,
            s2 = params.s2,
            g2 = params.g2,
...
def test():
    ...
    newCustBalB = sp.bytes("0x017D7840")
    newMerchBal = sp.tez(5)
    newMerchBalB = sp.bytes("0x004C4B40")
    ...
    scenario += c2.custClose(
        ...
        revLockB = revLock2, 
        newCustBalB = newCustBalB, 
        newMerchBalB = newMerchBalB, 
