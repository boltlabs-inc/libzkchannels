...
../target/$mode/zkchannels-mpc init --party CUST --other-port 12347 --own-port 12346 --index 0 --input-sats 50000 --output-sats 20000 --channel-name "$name" --txid f4df16149735c2963832ccaa9627f4008a06291e8b932c2fc76b3a5d62d462e1 
