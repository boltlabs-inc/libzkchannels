...
pub mod ffishim_bn256 {
    ...
    #[no_mangle]
    pub extern "C" fn ffishim_bn256_pay_prepare_merchant(
    ...
    #[no_mangle]
    pub extern "C" fn ffishim_bn256_pay_update_state_customer(
        ser_channel_state: *mut c_char,
        ser_customer_state: *mut c_char,
        amount: i64,
    ) -> *mut c_char {
    ...
    #[no_mangle]
    pub extern "C" fn ffishim_bn256_pay_update_state_merchant(
        ser_channel_state: *mut c_char,
        ser_pay_proof: *mut c_char,
        ser_merch_state: *mut c_char,
    ) -> *mut c_char {
    ...
    #[no_mangle]
    pub extern "C" fn ffishim_bn256_pay_unmask_customer(
        ser_channel_state: *mut c_char,
        ser_cust_state: *mut c_char,
    ...
    #[no_mangle]
    pub extern "C" fn ffishim_bn256_pay_validate_rev_lock_merchant(
    ...
    #[no_mangle]
    pub extern "C" fn ffishim_bn256_multi_pay_unmask_merchant(
