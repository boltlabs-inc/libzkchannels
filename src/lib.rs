...
/////////////////////////////// ZK proofs + blind sigs ////////////////////////////////
pub mod zkproofs {
    use rand::Rng;
    use util;
    use wallet;
    use pairing::Engine;
    use cl; // blind signature
    use secp256k1;
    use HashMap;
...
mod tests {
    ...
    #[test]
    fn zkproofs_payment_basics_work() {
        // just zkproofs case (w/o third party)
    ...
    #[test]
    fn zkproofs_multiple_payments_work() {
        let total_owed = 40;
        let b0_customer = 380;
        let b0_merchant = 20;
    ...
    #[test]
    fn zkproofs_payment_negative_payment_works() {
        // just zkproofs case (w/o third party)
        let total_owed = -20;
        let b0_customer = 90;
        let b0_merchant = 30;
    ...
    #[test]
    fn zkproofs_merchant_close_detects_double_spends() {
        let rng = &mut rand::thread_rng();
    ...
    #[test]
    #[should_panic]
    fn zkproofs_merchant_close_works() {
        let rng = &mut rand::thread_rng();
